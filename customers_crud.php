...
if (isset($_POST['create'])) {
  ...
  try {
    ...
    $stmt = $conn->prepare("INSERT INTO tbl_customers_a174856_pt2(fld_cust_id, fld_cust_name,
      fld_cust_phone, fld_cust_address) VALUES(:cid, :name, :phone,
      :address)");
    ...
    //nak guna variable ni dekat customer.php nanti.
    $cid = $_POST['cid'];
    $name = $_POST['name'];
    $phone =  $_POST['phone'];
...
if (isset($_POST['update'])) {
  ...
  try {
    ...
    $stmt = $conn->prepare("UPDATE tbl_customers_a174856_pt2 SET fld_cust_id = :cid,
      fld_cust_name = :name, fld_cust_phone = :phone,
      fld_cust_address = :address
