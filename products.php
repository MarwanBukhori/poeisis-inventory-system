...
<body>
  ...
  <!-- check user session and determine its role-->
          ...
          <div class="form-group">
            ...
            <div class="col-sm-9">
              <input name="pid" type="text" class="form-control" id="productid" placeholder="ID"
                value="<?php echo (isset($_GET['edit']) ? $pid : $nextid); ?>" required readonly>
            </div>
          </div>
          <div class="form-group">
            <label for="productname" class="col-sm-3 control-label">Name</label>
            <div class="col-sm-9">
              <input name="name" id="productname" type="text" class="form-control" placeholder="Name"
          ...
          <div class="form-group">
            ...
            <div class="col-sm-9">
              <select name="type" id="producttype" class="form-control" placeholder="Animal Type" required>
                ...
                <option value="SUPPLY"
                  <?php if(isset($_GET['edit'])) if($editrow['fld_type']=="Supply") echo "selected"; ?>>SUPPLY</option>
              </select>
            </div>
          </div>
